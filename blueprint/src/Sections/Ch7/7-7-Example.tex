...
\begin{theorem}[Existence condition]\label{thm:existence_condition}
  ...
  \leanok
  \uses{def:radii_poly,thm:general_radii_poly_theorem}
...
\begin{theorem}[Bounds verification]\label{thm:bounds_verified}
  \lean{Example_7_7.Y₀_bound_valid}
  \leanok
  % Also: Z₀_bound_valid, Z₁_bound_valid, Z₂_bound_valid
...
\begin{theorem}[Example 7.7 existence]\label{thm:example_7_7_main_theorem}
  \lean{Example_7_7.example_7_7_main_theorem}
  \leanok
  \uses{thm:general_radii_poly_theorem,thm:bounds_verified,def:radii_poly,thm:contraction_mapping}
...
\begin{theorem}[Squaring identity]\label{thm:eval_sq_eq}
  ...
  \leanok
  \uses{thm:example_7_7_main_theorem,thm:eval_mul,def:param_seq}
...
\begin{theorem}[Main result for Example 7.7]\label{thm:example_7_7_main_theorem_rat}
  \lean{Example_7_7_Final.example_7_7_main_theorem_rat}
  \leanok
  \uses{thm:example_7_7_main_theorem,thm:analytic_eq_sqrt}
  For $\lambda_0 = 1/3$, $\nu = 1/4$, and $N = 2$:
  \begin{enumerate}
...
\begin{proof}
  Part (1) follows from Theorem~\ref{thm:example_7_7_main_theorem} via the radii polynomial method.
