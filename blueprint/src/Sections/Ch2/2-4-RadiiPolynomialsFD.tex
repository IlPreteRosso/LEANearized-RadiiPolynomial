...
\begin{theorem}[Radii polynomial theorem in finite dimensions (Theorem 2.4.2)]\label{thm:radii_poly_fd}
  ...
  \leanok
  \uses{def:newton_like_map,def:radii_polynomial,prop:fixed_point_iff_zero,thm:fixed_point_radii,lem:poly_neg_implies_contraction,thm:neumann_series}
...
\begin{theorem}[Square root verification (Example 2.4.5)]\label{ex:sqrt2}
  \lean{example_2_4_5}
  \leanok
  \uses{thm:radii_poly_fd,def:radii_polynomial}
